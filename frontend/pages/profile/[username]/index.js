...
//   const { username } = params; // Now you can access username directly from params
  ...
  try {
    ...
    const [watchedMovies, cineFellows, watchlist, reviews, forums, userType, profileInfo, cinefellowCount, user ] = await Promise.all([
    ...
    if (watchedMovies.notFound || watchlist.notFound || reviews.notFound || forums.notFound || cineFellows.notFound || userType.notFound || profileInfo.notFound || user.notFound) {
      return { notFound: true };
    }
