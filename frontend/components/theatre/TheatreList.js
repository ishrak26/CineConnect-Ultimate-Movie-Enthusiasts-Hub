...
// import { SelectedTheatreContext } from '@/context/SelectedTheatreContext'
import { useState, useEffect } from 'react'

function TheatreList({ TheatreList }) {
  const elementRef = useRef(null)
  // const { selectedTheatre, setSelectedTheatre } = useContext(
  //   SelectedTheatreContext
  // )
