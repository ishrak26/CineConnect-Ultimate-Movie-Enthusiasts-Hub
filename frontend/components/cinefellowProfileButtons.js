...
// import { BiUserMinus } from "react-icons/bi"; // Import icons used in buttons
import {
  BiEdit,
  BiX,
  BiUserPlus,
  ...
  BiUndo,
  BiUserCheck,
} from 'react-icons/bi' // Import icons used in buttons
...
export const SendCinefellowRequestButton = ({ onClick }) => {
  return (
    <button className={styles.cinefellowRequestButton} onClick={onClick}>
      <BiUserPlus
        className={styles.cinefellowRequestIcon}
        size="24px"
        color="#FFFFFF"
      />
      CineFellow Request
...
export const WithdrawCinefellowRequestButton = ({ onClick }) => {
  return (
    <button
      className={styles.withdrawCinefellowRequestButton}
      onClick={onClick}
    >
      <BiUndo
        className={styles.withdrawCinefellowRequestIcon}
        size="24px"
        color="#FFFFFF"
      />
      Withdraw Request
...
export const RemoveCinefellowButton = ({ onClick }) => {
  ...
  return hoverState ? (
    ...
    >
      <BiUserX
        className={styles.removeCinefellowIcon}
        size="24px"
        color="#FFFFFF"
      />
      Remove Cinefellow
    ...
    >
      <BiUserCheck
        className={styles.isCinefellowIcon}
        size="24px"
        color="#FFFFFF"
      />
      Cinefellows
