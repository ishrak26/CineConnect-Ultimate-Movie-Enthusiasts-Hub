...
router.get('/profile/:username/cinefellows/count', userController.getCineFellowCount);

// Route to follow a CineFellow
router.post('/profile/:username/cinefellows/follow', userController.followCineFellow);

// Route to unfollow a CineFellow
router.post('/profile/:username/cinefellows/unfollow', userController.unfollowCineFellow);

// Route to withdraw a CineFellow request
router.post('/profile/:username/cinefellows/withdraw-request', userController.withdrawCineFellowRequest);
...
router.post('/requests/:requestId/accept', userController.acceptSpecificPendingRequest);

// for rejecting a pending request
router.post('/requests/:requestId/reject', userController.rejectSpecificPendingRequest);

// Accept CineFellow request
router.post('/profile/:username/cinefellows/accept', userController.acceptCineFellowRequest);

// Reject or cancel CineFellow request
router.post('/profile/:username/cinefellows/reject', userController.rejectCineFellowRequest);
...
router.get('/profile/:username/search', userController.searchProfilesByUsername);
...
router.get('/profile/:username/identify-profile', userController.identifyProfileHolder);
